                            ...
                            <form class="form-horizontal J_searchForm">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-2 margin-bottom-10 margin-top--10 pull-left">
                                        <a class="btn btn-success btn-radius-no J_search margin-left-15" type="button"><i class="fa fa-search"></i>&nbsp;搜索</a>
                            ...
                            <div class="table-responsive col-sm-12">
                                <table class="J_table table table-hover table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        <td>管理员</td>
                                        <td>
                                            <a href="/html/pc-admin/student-information-management/student-information-detail.html#?id='1'" class="label-info J_modify"><i class="fa fa-pencil"></i>&nbsp;新增</a>
...
<script src="${ctx}/static/bootstrap-3.3.5/js/student-information-list.js"></script>
